      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-4 col-lg-4 foot-1">
            <img src="images/logo-nb1.png" alt="logo" className="img-logo" />
            <p>
              The best tiffin service in the Waterloo. Grab new offers and
              register now!
              <br />
              Subscribe, Eat, Enjoy!
              <br />
              &copy; 2023 Tiffin-Express
            </p>
          ...
          <div className="col-sm-4 col-lg-4 foot-3">
            <h3>Contact us:</h3>
            <p>
              <i className="fa-sharp fa-solid fa-phone"></i> +1 234-456-7890
            </p>
            <p>
              <i className="fa-solid fa-envelope"></i> tiffinexpress@gmail.com
            </p>
            <p>
              <i className="fa-solid fa-location-dot"></i> Waterloo, ON, CA
            </p>
          </div>
        </div>
      </div>
